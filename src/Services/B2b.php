...
class B2b extends MpesaPhpApiHttpClient
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->senderIdentifierType = $this->identifier[config('mpesa-php-api.initiator.type')];

        $this->queueTimeOutURL = $this->setUrl(config('mpesa-php-api.queue_timeout_url.b2b'));
        $this->resultURL = $this->setUrl(config('mpesa-php-api.result_url.b2b'));
    }
